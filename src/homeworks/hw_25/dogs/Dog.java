...
public class Dog {
    ...
    private boolean success; // Перепрыгнут ли барьер
    ...
    public void info() {
        ...
        System.out.printf("Dog %s; current jump: %.0f. Max jump:%.0f", name, initHeight, maxHeight);

    }
    public String toString() {
        return String.format("Dog %s; current jump: %.0f. Max jump: %.0f", name, initHeight, maxHeight);
    }

    public void jump() {
       System.out.println("Собачка "+name+" успешно прыгнула на высоту " + curHeight + "см.");
        success = true;
